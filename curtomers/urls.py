...
from curtomers.views import CustomerSignupView, customer_add_order, customer_driver_location, customer_get_detais, customer_get_latest_order, customer_get_order_history, customer_get_restaurants, customer_update_profile
