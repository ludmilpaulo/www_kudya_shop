...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # 4. Exchange Rates (today; model uses auto_now_add on date so we only seed one day)
        ...
        if store_cat and store_type:
            ...
            if store_created:
                # Opening hours: Mon–Fri 8–22h, Sat 9–15h, Sun closed
                ...
                if prod_cat_ref:
                    products_data = [
                        ("Frango Grelhado", 2500, "Frango grelhado com arroz, salada e molho. Prato do dia às terças.", prod_cat_ref),
                        ("Mufete", 1800, "Peixe grelhado com funje, banana e molho de tomate. Tradicional angolano.", prod_cat_ref),
                        ("Calulu", 2200, "Carne seca com quiabo, óleo de palma e batata-doce.", prod_cat_ref),
                        ...
                        ("Carne de Porco à Braz", 2100, "Porco guisado com batata palha e ovo.", prod_cat_ref),
                        ("Feijão com Óleo e Arroz", 1200, "Feijão vermelho com óleo de palma, arroz e couve.", prod_cat_ref),
                        ...
                        ("Pão com Manteiga e Ovo", 800, "Pão quente com manteiga e ovo estrelado.", prod_cat_snack or prod_cat_ref),
                    ]
        ...
        try:
            ...
            # Day-to-day orders: last 14 days, 2–5 orders per day
